...
class _SelectedBoxState extends State<SelectedBox> {
  ...
  void onCheckandSaveInventory() async {
      ...
      try {
        ...
        String _remarks = await _inventoryCheckService.checkBoxModule(docId);

        if (_remarks != 'ERROR IN CHECK BOX') {
          await _inventoryCheckService.recordData(docId, _loginName, _groupNumStr, _remarks);
        }
