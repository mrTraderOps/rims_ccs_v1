...
class Excess extends StatefulWidget{
  ...
  @override
  State<Excess> createState() => _ExcessState();
}

class _ExcessState extends State<Excess> {
  ...
  String get collectionPath => '/inventory/group$_groupNumStr-$docId/excess';
